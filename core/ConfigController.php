...
class ConfigController
{
    ...
    {   
        //echo "<br/><br/><br/>";
        $listar_pagina = new \Sts\Models\StsPaginas();
        $this->Paginas = $listar_pagina->listar_paginas($this->UrlController);
        ...
        if ($this->Paginas) {
            ...
            if (class_exists($this->Classe)) {
                ...
                $this->UrlController = $this->slugController(CONTROLER);
                $this->carregar(); //aqui pode ser direcionado para um página 404 personalizada
            }
        } else {
            $this->UrlController = $this->slugController(CONTROLER);
            $this->carregar(); //aqui pode ser direcionado para um página 404 personalizada
